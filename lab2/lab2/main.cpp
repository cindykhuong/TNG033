...
int main() {
...

    {
        ...
        //because Polynomial[] takes in an int and it is assign to a double (-4.4), which is wrong!
...

    {
        ...
        std::string tmp3{os3.str()};
        assert(
            (tmp3 ==std::string{ "p1 = 10.90 + 13.20 * X^1 + 6.00 * X^2 + 5.00 * X^3 + 3.10 * X^4 + 6.60 * X^5"}));
    }
...
//
//        //delete the operator if it tries to compile in expression.h
